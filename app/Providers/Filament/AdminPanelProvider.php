    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->renderHook(
                ...
                fn (): HtmlString => new HtmlString('<style>@font-face{font-family:"Material Symbols Rounded";font-style:normal;font-weight:100 700;font-display:swap;src:url("/fonts/material-symbols-rounded.woff2?v=20260810-4") format("woff2");}.material-symbols-rounded{font-family:"Material Symbols Rounded";font-weight:400;font-variation-settings:"FILL" 0,"wght" 400,"GRAD" 0,"opsz" 24;font-feature-settings:"liga";display:inline-block;white-space:nowrap;text-transform:none;letter-spacing:normal;-webkit-font-smoothing:antialiased;}</style><style>.fi-fo-rich-editor-main > .fi-fo-rich-editor-content, .fi-fo-rich-editor-main > .fi-fo-rich-editor-content [contenteditable="true"] { min-height: 220px; } @media (max-width: 640px) { .fi-fo-rich-editor-main > .fi-fo-rich-editor-content, .fi-fo-rich-editor-main > .fi-fo-rich-editor-content [contenteditable="true"] { min-height: 180px; } }</style>'),
            )
            ->colors([
                'primary' => Color::Amber,
            ])
